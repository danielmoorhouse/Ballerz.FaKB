...
using Ballerz.Football.Models.Countries;
...
namespace Ballerz.Football.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public IActionResult ContCountries(int id)
        {
            ViewBag.ContinentName = _db.Continents.Where(e => e.Id == id).FirstOrDefault().ContinentName;
            var countries = _countriesService.GetAll()
